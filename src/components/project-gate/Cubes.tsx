...
const Cubes = ({
  ...
  const tiltAt = useCallback(
    (rowCenter: number, colCenter: number) => {
      ...
      (sceneRef.current.querySelectorAll(".cube") as NodeListOf<HTMLElement>).forEach((cube) => {
  ...
  const onClick = useCallback(
    ...
    [rippleOnClick, gridSize, faceColor, rippleColor, rippleSpeed, onCubeClick]
  );
